...
JSON Example : {
    "Marijuana/Combo/Cultivation/Renewal": {
      "ConvertToRealCapAfter": [
       {
         "preScript": "",
         "usageType": "copyFromParent",
         "recordType": "Marijuana/Combo/Cultivation/License",
         "Renewal":true,
         "CONTACTS": "ALL",
         "ASI": "ALL",
         "ASIT": "ALL",
...
- for items to copy, ex "ASIT", values allowed "ALL" copy all, "TYPE" copy this TYPE only, "" don't copy
Notes:
	...
	if (isConfigurableScript(settingsArray, scriptSuffix)) {
		...
		for (s in settingsArray) {
			...
			if (rules.Renewal) {
				...
				if (pID != null && pID != "") {
					var result = aa.cap.createRenewalCap(pID, capId, true);
				}
			}
